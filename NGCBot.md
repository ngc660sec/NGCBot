...
![image-20240102112921682](./NGCBot.assets/image-20240102112921682.png)

下载我提供的微信版本，注意不能更新微信⚠️

![image-20240102113006755](./NGCBot.assets/image-20240102113006755.png)
...
![image-20240102113236687](./NGCBot.assets/image-20240102113236687.png)

若出现此问题，请使用任务管理器关闭微信重启运行此文件

![image-20240102113314858](./NGCBot.assets/image-20240102113314858.png)

进入微信之后，会自动初始化必备文件

![image-20240102113357436](./NGCBot.assets/image-20240102113357436.png)
...
![image-20240102114003272](./NGCBot.assets/image-20240102114003272.png)

拿到此`wxid`，放到配置文件当中即可

![image-20240102114040738](./NGCBot.assets/image-20240102114040738.png)
...
![image-20240102140407434](./NGCBot.assets/image-20240102140407434.png)

若不想被踢，则先要添加白名单，用管理员账户发一次即可添加

![image-20240102141032829](./NGCBot.assets/image-20240102141032829.png)

解除白名单则发送配置文件中你配置的关键词

![image-20240102141132462](./NGCBot.assets/image-20240102141132462.png)

![image-20240102141146845](./NGCBot.assets/image-20240102141146845.png)

注意需要引用消息！！！

**2、添加管理**

![image-20240102141225140](./NGCBot.assets/image-20240102141225140.png)

**3、删除管理**

![image-20240102141248781](./NGCBot.assets/image-20240102141248781.png)

**4、关键词进群**

需要先拿到`roomid`，再在配置文件中设置即可

![image-20240102141340027](./NGCBot.assets/image-20240102141340027.png)

![image-20240102141359101](./NGCBot.assets/image-20240102141359101.png)
...
![image-20240102141454885](./NGCBot.assets/image-20240102141454885.png)

关键词可设置多个，回复内容只限文本。群聊或好友都可触发

![image-20240102141826989](./NGCBot.assets/image-20240102141826989.png)

**6、加好友后自动回复**
添加好友后自动回复一条消息，在配置文件中设置

![image-20240102141926511](./NGCBot.assets/image-20240102141926511.png)

**7、进群欢迎**
当有人加入群聊后，自动回复一条消息，在配置文件中设置

![image-20240102142025194](./NGCBot.assets/image-20240102142025194.png)
...
![image-20240102142615234](./NGCBot.assets/image-20240102142615234.png)

机器人会自动推送消息到推送群聊

![image-20240102142632603](./NGCBot.assets/image-20240102142632603.png)
...
![image-20240102142326296](./NGCBot.assets/image-20240102142326296.png)

发送开启推送即可在此群开启推送服务，关键词可以设置多个，代表这两个关键词都可以触发这个功能

![image-20240102142405384](./NGCBot.assets/image-20240102142405384.png)

踢人功能使用也很简单，需要@罢了

![image-20240102142435128](./NGCBot.assets/image-20240102142435128.png)

**添加积分：需要@用户，可@多个用户，注意空格。使用如下【@群友1加空格[积分]】**

![image-20240102143144061](./NGCBot.assets/image-20240102143144061.png)
...
![image-20240102143451823](./NGCBot.assets/image-20240102143451823.png)

出现此类问题一般是接口不稳定，或者网络不稳定，重新发送即可

![image-20240102143552170](./NGCBot.assets/image-20240102143552170.png)

**视频**

![image-20240102143657189](./NGCBot.assets/image-20240102143657189.png)

**舔狗日记**

![image-20240102143647920](./NGCBot.assets/image-20240102143647920.png)

**解梦**

![image-20240102143721164](./NGCBot.assets/image-20240102143721164.png)
...
![image-20240102143903435](./NGCBot.assets/image-20240102143903435.png)

**积分查询**

![image-20240102143921467](./NGCBot.assets/image-20240102143921467.png)

**送积分功能**

![image-20240102144026831](./NGCBot.assets/image-20240102144026831.png)
...
![关注](./NGCBot.assets/%E5%85%B3%E6%B3%A8-4177997.gif)

**机器人微信：**

![image-20240102144805775](./NGCBot.assets/image-20240102144805775.png)
